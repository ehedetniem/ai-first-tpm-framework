...
5) If Copilot has workspace command access, run `python agents/pulse-orchestrator/pulse.py reports`; otherwise tell me to run it manually.
...
3) If Copilot has workspace command access, run `python agents/pulse-orchestrator/pulse.py reports`; otherwise tell me to run it manually.
