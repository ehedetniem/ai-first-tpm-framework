...
5) If Copilot can run terminal commands in your environment (for example, Copilot Coding Agent sessions), run `python agents/pulse-orchestrator/pulse.py reports`; otherwise tell me to run it manually.
...
3) If Copilot can run terminal commands in your environment (for example, Copilot Coding Agent sessions), run `python agents/pulse-orchestrator/pulse.py reports`; otherwise tell me to run it manually.
